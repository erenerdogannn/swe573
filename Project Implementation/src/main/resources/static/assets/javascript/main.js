...
var urlRoot = "http://ec2-54-186-186-232.us-west-2.compute.amazonaws.com:8080/unikoop";
...
function validateSignInForm() {
    ...
    if (email == "admin@unikoop.com" && password == "123456")  {
        ...
        window.location.pathname = "unikoop/volunteer.html";
        return false;
...
function validateSignUpForm() {
    ...
    window.location.pathname = "unikoop/signin.html";
    return false;
}
...
$('#sign-out-btn').on('click', function() {
    ...
    window.location.pathname = "unikoop/index.html";
